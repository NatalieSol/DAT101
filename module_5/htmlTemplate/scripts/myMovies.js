...
export class TMyMovies extends TBootstrapComponent {
  ...
  constructor(){
    ...
    //Hvis vi har filmer i local storage, må vi hente ut disse
  ...
  #loadMovies(){
    ...
    for(let i = 0; i < this.#movies.length; i++){
      //Redesign til å bruke en felles funksjon for å legge til en rad
...
class TMovieForm extends TBootstrapComponent {
  ...
  #onSubmitForm = (aEvent) => {
    ...
    for(let i = 0; i < this.#genreElements.length; i++){
      //Oppgaven nå er å legge til kun de valgte sjangerne!
