...
export class TMenu {
  ...
  constructor(aSpriteCanvas) {
    ...
    const pos = new lib2d.TPosition(210, 150);
    //Bruk denne koden for å jukse litt og starte spillet direkte
  ...
  draw() {
    switch (GameProps.status) {
      ...
      case EGameStatus.getReady:
        ...
        this.#spNumber.draw();
        GameProps.sounds.countDown.play(); //Spiller av nedtellingslyd
        break;
      case EGameStatus.gameOver:
        ...
        if (!this.#isSoundPlayed) {
          GameProps.sounds.gameOver.play(); //Spiller dunkelyd når du treffer bakken
          GameProps.sounds.heroIsDead.play(); //Game over lyd
