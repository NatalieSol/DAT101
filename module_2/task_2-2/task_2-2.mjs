...
printOut("--- Part 2 ----------------------------------------------------------------------------------------------");
/* Convert 25 metres and 34 centimeters to inches. An inch is 25.4 /inch*/
/*
(25.4 * / 1000) * 25.34m 
*/
...
printOut("Character at position number 19 is: " + text.charAt(19));
printOut("Characters 35 and 8 forward are: " + text.substr(35, 8));
